"""
Django settings for MP50 project.
...
SECRET_KEY = "django-insecure-n!t)eo3tubl^j_236v%u6$2%t122)ooa&)1pfr^%h63&@&9^_@"
...
ROOT_URLCONF = "MP50.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [
            os.path.join(BASE_DIR, "MP50", "templates"),
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "MP50.wsgi.application"
